...
function timeControls(){
 const header=document.querySelector('.site-header');if(!header||!['home','chat'].includes(current)){document.querySelector('.time-controls')?.remove();return;}
